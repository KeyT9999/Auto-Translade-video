...
VALIDATOR_TIMING_OVERFLOW_AS_ERROR = _get_bool_env("VALIDATOR_TIMING_OVERFLOW_AS_ERROR", False)
...
SUBTITLE_MASK_Y_PERCENT = float(os.getenv("SUBTITLE_MASK_Y_PERCENT", "0.85"))
SUBTITLE_MASK_HEIGHT_PERCENT = float(os.getenv("SUBTITLE_MASK_HEIGHT_PERCENT", "0.12"))
SUBTITLE_MASK_OPACITY = float(os.getenv("SUBTITLE_MASK_OPACITY", "1.0"))
SUBTITLE_MASK_EXTRA_HEIGHT_PERCENT = float(os.getenv("SUBTITLE_MASK_EXTRA_HEIGHT_PERCENT", "0.0"))
SUBTITLE_MASK_EXTRA_OPACITY = float(os.getenv("SUBTITLE_MASK_EXTRA_OPACITY", "1.0"))
